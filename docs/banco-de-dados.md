...
| `V7__create_escalacao_rodada.sql` | Tabela `escalacao_rodada` — histórico de escalações por rodada (ver [9.12](regras-de-negocio.md#histórico-de-escalações-por-rodada)) |
...
|---|---|---|
| `oddLimite` | `3.0` | Odd máxima para um time entrar como favorito (ver [9.1](regras-de-negocio.md#identificação-de-times-favoritos)) |
...
| `evitarMesmoClubeDefesa` | `true` | Não repetir clubes entre GOL, LAT e ZAG (ver [9.6](regras-de-negocio.md#defesa-sem-clube-repetido)) |
| `limiteAtletasPorClube` | `4` | Teto de titulares do mesmo clube, incluindo TEC (ver [9.8](regras-de-negocio.md#limite-máximo-por-clube-inclui-tec)) |
| `budgetMaximo` | `0.0` | Teto de cartoletas; `0` desliga a restrição (ver [9.9](regras-de-negocio.md#budget-máximo-c-e-otimização-por-orçamento)) |
